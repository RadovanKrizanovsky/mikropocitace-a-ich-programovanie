...
const unsigned int vzorky[] = { 2046, 2247, 2445, 2640, 2829, 3010, 3183, 3344,
                                3493, 3628, 3747, 3850, 3936, 4004, 4053, 4082,
                                4092, 4082, 4053, 4004, 3936, 3850, 3747, 3628,
                                3493, 3344, 3183, 3010, 2829, 2640, 2445, 2247,
                                2046, 1845, 1647, 1452, 1263, 1082, 909, 748,
                                599, 464, 345, 242, 156, 88, 39, 10, 0, 10, 39,
                                88, 156, 242, 345, 464, 599, 748, 909, 1082,
                                1263, 1452, 1647, 1845, 2046,
                                2247 //};
                                , 2445, 2640, 2829, 3010, 3183, 3344, 3493,
                                3628, 3747, 3850, 3936 };
...
#define tlv5636_cntrl_REF_2V   0x9002
...
// inicializacia P1
    ...
    P1OUT = 0x00;
    P1DIR |= BIT6;  // pin P1.6 bude generova pulz FS
...
/*
 * ZAVER:
 * 1)Prestudovali sme fungovanie D-A prevodnika
 * 2)Sledovali sme ako pri zmene napatia vznikali na osciloskope sinusoidy tvorene reprezentaciou hodnot zo "vzoriek"
 * 3)Programovali sme v jazyku c
 * 4)Nastavili sme clock polarity a clock phase do log. 1
 * 5)Referencne napatie sme mali nastavene na 1.024V
 * 6)Zmenou fazy sme menili tvar sinusoidov
 * 7)Pridali sme ISR pre enkoder a modifikovanim frekvencie sme poculi rozne "verzie" zvuku/piskania
 * 8)Na zaver sme si ukazali ako by takyto program mohol fungovat aj bez pouzitia tabulky a vzorky boli generovane "za behu" programu
 */
