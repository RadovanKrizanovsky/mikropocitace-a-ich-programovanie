...
/*
 * ZAVER:
 * 1)Prestudovali sme vyhody, vyuzitie a funkcie I2C zbernice
 * 2)Programovali sme v jazyku c
 * 3)Data sme posielali z master-u od slave-u
 * 4)Postup odosielania bol: adresa, r/w bit, ACK potvrdenie
 * 5)Data sa posielali po 8mich bitoch
 * 6)Po tom ako sme odoslali vsetko sa beh zastavil
 * 7)Na osciloskope sme vyskusali aj ako vyzera priebeh za predpokladu ze posleme zlu adresu
 * 8)Na zaver sme kod upravili tak aby po provom nespravnom "zbehnuti" zmenila adresu slave-u aby odosielanie prebiehalo spravne
 */
